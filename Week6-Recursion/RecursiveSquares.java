...
public class RecursiveSquares {
    ...
    public static void draw(int n, double x, double y, double length) {
        ...
        draw(n - 1, x0, y1, length / 2); // upper left square
        draw(n - 1, x1, y1, length / 2); // upper right square
        drawSquare(x, y, length); // main square
        draw(n - 1, x0, y0, length / 2); // lower left square
        draw(n - 1, x1, y0, length / 2); // lower right square
